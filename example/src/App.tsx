...
import FhirUserUi from 'fhiruser-ui';
import 'fhiruser-ui/dist/index.css';

const App = () => {
  return <FhirUserUi iss="https://r4.smarthealthit.org"
    introspectEndpoint="https://apporchard.epic.com/interconnect-aocurprd-oauth/oauth2/introspect"
    tokenResponse={{
